...
?>
구매문의 게시판입니다.
<table class="list-table" id="board_area">
  <thead>
    <tr>
      <th width="50">번호</th>
      <th width="350">제목</th>
      ...
      <tbody>
        <tr>
          ...
          <td width="350">
            <?php
              ...
              { ?><a href='/ssy/page/board/ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
        ...
        <?php
          ...
          ?>
        <!-- 추가부분 18.08.01 END -->
        <a href='/ssy/page/board/read.php?idx=<?php echo $board["idx"]; ?>'><?php echo $title; }?><span class="re_ct">[<?php echo $rep_count;?>]<?php echo $img; ?> </span></a></td>
...
<div class="b_li_bot">
  ...
  <div id="write_btn">
        <a href="/ssy/page/board/write.php"><button>글쓰기</button></a>
  </div>
  <div id="search_box">
    <form action="/ssy/page/board/search_result.php" method="get">
      <select name="catgo">
